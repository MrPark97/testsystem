...
<div class="row">
  ...
  {{range .Tests}}
    <div class="row">
      <div class="input-field col s12">
        ...
        <p>
          <input class="with-gap" name="group{{.Id}}" value="{{.B}}" type="radio" id="test{{.Id}}B" />
          <label for="test{{.Id}}B">{{.B}}</label>
        </p>
        <p>
          <input class="with-gap" name="group{{.Id}}" value="{{.C}}" type="radio" id="test{{.Id}}C" />
          <label for="test{{.Id}}C">{{.C}}</label>
        </p>
        <p>
          <input class="with-gap" name="group{{.Id}}" value="{{.D}}" type="radio" id="test{{.Id}}D" />
          <label for="test{{.Id}}D">{{.D}}</label>
        </p>
      </div>
    </div>
  {{end}}
  <div class="row">
    <div class="col s12">
    <input type="hidden" value="testComplete" name="testStatus">
